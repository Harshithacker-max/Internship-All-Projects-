...
def home():
    ...
    <div class='container'>
        ...
        <p>Hello! I'm <b>Harshit Raj Shriwastva</b>, a Tech Student and Creative Video Editor.</p>
        <ul>
...
def resume():
    ...
    <div class='container'>
        ...
        <p><b>Name:</b> Harshit Raj Shriwastva </p>
        ...
        <p>Email: <a href="mailto:ghanshyam@example.com">ghanshyam@example.com</a></p>
